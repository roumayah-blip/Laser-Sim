...
def pump_rate_per_ion(
    ...
    *,
    ...
    """(W_p,abs, W_p,esa) per ion; ``ip_w_m2`` = P/A_pump (do not apply Γ_p again)."""
    _ = gamma_p
    w_p = ip_w_m2 / hnu_p
...
def steady_state_n2_fraction_pump(
    ...
    """Upper-state fraction N₂/N_tot under pump only."""
...
def advance_pump_power_z(
    ...
    *,
    ...
    """α_p = Γ_p·(σ_p·N₀ − σ_ep·N₂) when ``n2``/``sigma_ep`` given, else Γ_p·σ_p·N₀."""
